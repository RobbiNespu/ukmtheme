...
<div id="ut-tools" class="uk-offcanvas">
  ...
  <p><?php _e( 'Press esc key to close', 'ukmtheme' ); ?></p>
    ...
    <ul>
      <li><a href="#" class="reset_btn"><i class="uk-icon-circle tools-color-1st">&nbsp;</i><?php _e('Theme One','ukmtheme'); ?></a></li>
      <li><a href="#" class="snd_btn"><i class="uk-icon-circle tools-color-2nd">&nbsp;</i><?php _e('Theme Two','ukmtheme'); ?></a></li>
