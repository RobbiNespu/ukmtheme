      ...
      <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        <div class="pure-g">
          ...
          <section class="pure-u-1-1">
            <div class="pure-uumn ut_divider">
              <div class="pure-u-3-10 article">
            ...
            ?>
            <div class="pure-uumn ut_divider <?php if ( $hide_consultation == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_journal == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_proceedings == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_book == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_antologi == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_monograph == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_seminar == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_award == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_supervision == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_administrative == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_reports == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_research_grant == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
            ...
            <div class="pure-uumn ut_divider <?php if ( $hide_teaching == on ) { echo 'ut_hidden'; } ?>">
              <div class="pure-u-3-10 article">
