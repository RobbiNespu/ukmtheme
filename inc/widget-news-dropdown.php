...
class Latest_News_Widget_Dropdown extends WP_Widget {
  function __construct() {

    parent::__construct(

      'latest_news_widget_dropdown', // Base ID
...
function register_Latest_News_Widget_Dropdown() {
  register_widget( 'Latest_News_Widget_Dropdown' );
}

add_action( 'widgets_init', 'register_Latest_News_Widget_Dropdown' );
