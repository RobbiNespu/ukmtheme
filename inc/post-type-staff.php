...
function ut_staff_directory() {
  ...
  $args = array(
    ...
    'taxonomies'          => array( 'staffcat', 'department', 'position' ),
    'hierarchical'        => true,
    'public'              => true,
    'show_ui'             => true,
    'show_in_menu'        => true,
...
// Hook into the 'init' action
add_action( 'init', 'ut_staff_directory_category', 0 );
